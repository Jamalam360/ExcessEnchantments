...
public class EEConfig extends com.oroarmor.config.Config {
    ...
    public static class ConfigGroupEnabledEnchantments extends ConfigItemGroup {
        ...
        public ConfigGroupEnabledEnchantments() {
            super(of(AQUA_ASPECT_ENABLED, MARATHON_ENABLED, FROST_ENABLED, SNOW_CURSE_ENABLED, BLUNT_CURSE_ENABLED, BUTCHER_ENABLED, WARP_ENABLED, SLIPPERY_CURSE_ENABLED, HAPHAZARD_ENABLED, SWIFT_ENABLED, VAMPIRE_ENABLED, ADRENALIN_ENABLED, LAST_STAND_ENABLED, HUNGER_CURSE_ENABLED, FIRE_THORNS_ENABLED, AERIAL_ENABLED), "enchantments");
        }
    }
}
